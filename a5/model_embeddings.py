...
class ModelEmbeddings(nn.Module):
    ...
    def __init__(self, word_embed_size, vocab):
        ...
        self.embeddings = nn.Embedding(num_embeddings = self.num_embeddings, embedding_dim = self.char_embed_size, padding_idx = self.padding)
    ...
    def forward(self, input):
        ...
        embedding = input.contiguous().view(sentence_length * batch_size, max_word_length)
        ...
        output = output.contiguous().view(sentence_length, batch_size, -1)
